...
$(document).ready(function(){
    //changes the color based on if input box is in focus
    $('input').focusin(function(){
        $(this).css("backgrounf-color", "#FFFFCC");
    }),
    $('input').focusout(function(){
        $(this).css("backgrounf-color", "white");
    }),
    ...
    $('#multForm').validate({
        ...
        highlight: function(element){
            $(element).closest('.form-control input-lg valinp').removeClass('success').addClass('error');
        },
        
        success: function(element){
            element.closest('.form-control input-lg valinp').removeClass('error').addClass('success');
        }
        /*
